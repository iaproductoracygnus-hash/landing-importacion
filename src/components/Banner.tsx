export function Banner() {
  return (
    <div
      className="w-full flex items-center justify-center min-h-[62px] py-3 md:py-0 md:h-[62px]"
      style={{ backgroundColor: "rgb(22, 158, 254)" }}
    >
      <p className="text-center text-[14px] md:text-[24px] font-[family-name:var(--font-montserrat)] px-4">
